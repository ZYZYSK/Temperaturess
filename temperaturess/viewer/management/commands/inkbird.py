...
class Inkbird:
    def __init__(self, address: str, handle: str, channel_id: str, write_key: str, logger: logging.Logger) -> None:
        # MAC address
    ...
    def save(self):
        ...
        if self.tm.hour == 0 and self.tm.minute == 0:
            try:
                ...
                timedatas = TimeData.objects.filter(tm__year=day.year, tm__month=day.month, tm__day=day.day)
